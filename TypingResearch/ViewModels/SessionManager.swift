...
final class SessionManager {
    ...
    private static let topRowLabels: Set<String> = [
        "q","w","e","r","t","y","u","i","o","p",
        "1","2","3","4","5","6","7","8","9","0"
    ]
    private static let middleRowLabels: Set<String> = [
        "a","s","d","f","g","h","j","k","l",
        "-","/",":",";","(",")","$","&","@","\""
    ]
    private static let bottomRowLabels: Set<String> = [
        "z","x","c","v","b","n","m",
        "delete",".",",","?","!","'"
    ]
    private static let keyColumnRows: [[String]] = [
        ["q","w","e","r","t","y","u","i","o","p"],
        ["a","s","d","f","g","h","j","k","l"],
        ["z","x","c","v","b","n","m"],
        ["1","2","3","4","5","6","7","8","9","0"],
